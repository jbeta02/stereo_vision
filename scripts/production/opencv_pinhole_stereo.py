...
def rectify_images():
    ...
    for img_l, img_r in zip(imgs_l, imgs_r):
        ...
        cv2.imwrite(f"{full_path}/test_images/out/left/left_rectified_img_pinhole_{i}.png", left_rect)
        cv2.imwrite(f"{full_path}/test_images/out/right/right_rectified_img_pinhole_{i}.png", right_rect)
        i+=1
...
def build_disparity_map(
    ...
    # create depth map
    img_path0 = f"{full_path}/test_images/out/left/left_rectified_img_pinhole_0.png" # left
    img_path1 = f"{full_path}/test_images/out/right/right_rectified_img_pinhole_0.png" # right
